...
- **Marcadores nomeados e acesos no velocímetro**: cada faixa do velocímetro (Abaixo, Normal, Sobrepeso, Obesidade) agora tem seu nome exibido acima, na cor da própria faixa. Na home, o rótulo acende (fica opaco e com brilho) exatamente quando o ponteiro da prévia passa por cima daquela faixa, sincronizado com a animação. No resultado real, o rótulo correspondente ao IMC calculado já aparece aceso. A legenda antiga (linha de bolinhas abaixo do velocímetro) foi substituída por esses marcadores integrados ao mostrador.
- **Correção do mapeamento de cores**: o velocímetro agora segue exatamente vermelho → verde → amarelo → vermelho da esquerda para a direita — vermelho para abaixo do peso, verde para peso normal, amarelo para sobrepeso, vermelho para obesidade (qualquer grau).
